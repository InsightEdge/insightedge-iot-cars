...
object ProducerApp extends App{
  ...
  val kafkaConfig = {
    ...
    props.put(CSV_LOCATION, mapArgs.getOrElse(CSV_LOCATION,"/home/yuval/opt/magic/gigaspaces-insightedge-1.0.0-premium/temp2.csv"))
  ...
  mapArgs.get("type") match {
    case Some("infinity") => CSVProducer.infinity(kafkaConfig, mapArgs)
